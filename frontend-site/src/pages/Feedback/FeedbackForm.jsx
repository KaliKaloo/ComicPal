            ...
            <div className="grid md:grid-cols-2 gap-2">
              <label className="flex space-x-3">
                <input
                  ...
                  {...register("Question6")}
                />
                <div className="cursor-pointer">Plan a Story tool</div>
              </label>
              ...
              <label className="flex space-x-3">
                <input
                  ...
                  {...register("Question6")}
                />
                <div className="cursor-pointer">Create a Comic Page tool</div>
              </label>
              ...
              <label className="flex space-x-3">
                <input
                  ...
                  {...register("Question6")}
                />
                <div className="cursor-pointer">Design a Character tool</div>
              </label>
              <label className="flex space-x-3">
                <input
                  type="checkbox"
          ...
          <div className="mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-2">
              ...
              <label className="flex space-x-3">
                ...
                />
                <div className="cursor-pointer">
                  Edit the generated images by cropping, rotating etc
                </div>
              </label>
              <label className="flex space-x-3">
                <input
                ...
                />
                <div className="cursor-pointer">
                  When planning a story, have a narrative timeline with the
                  ability to move around story points
                </div>
              </label>
              <label className="flex space-x-3">
                <input
                ...
                />
                <div className="cursor-pointer">
                  Remember the characters created and use them when creating a
                  comic page
                </div>
              </label>
            </div>
