...
function HeroSection() {
	...
	return (
		<section
			id="home"
			className={`flex lg:flex-row flex-col ${styles.paddingY} space-x-10`}
		>
			<div
				className={`flex-1 flex ${styles.flexCenter} lg:my-0 my-10 relative mx-2`}
			>
				<img
					src={heroImg}
					alt="hero-img"
					className=" w-[80%] h-[80%] lg:w-[100%] lg:h-[100%]  relative z-[5] object-contain"
				/>
			</div>
			...
			>
				...
				<p className={`${styles.paragraph} max-w-[470px] mt-5`}>
					An AI assisted tool built to help creatives brainstorm comic
					pages, panels and characters as well as storyboard. You are
					the creative lead with an AI assistant!
				</p>
				<div className="flex flex-row justify-between items-center w-[470px]">
					<MainButton
						styles="mt-6 mb-10 bg-darkGreen text-white"
						text="About"
