...
function GeneratePanel({deleteFunc, index}) {
  ...
  return (
    <div>
      {panelClick ? 
      <div className="absolute inset-y-0 right-0 mr-[-3.5rem] z-20 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 shadow-lg backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50  top-2/4 -translate-y-2/4 min-h-[auto] min-w-[44px] flex-col rounded-lg border
      ">
        {editMode ? <CheckIcon
      ...
      <div className="border border-black overflow-hidden bg-gray-100 w-[400px] h-[200px] resize" onClick={()=>setPanelClick(true)}>
        {imageURL.length > 0 ? (
